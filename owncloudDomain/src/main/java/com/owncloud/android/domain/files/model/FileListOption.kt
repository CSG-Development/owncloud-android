...
enum class FileListOption : Parcelable {
    ALL_FILES, SPACES_LIST, SHARED_BY_LINK, AV_OFFLINE, UPLOADS_LIST, GLOBAL_SEARCH, FAVORITES, TAG_FILES, TRASH;
    ...
    fun isTagFiles() = this == TAG_FILES
    fun isTrash() = this == TRASH
}
