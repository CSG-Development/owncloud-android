...
@Deprecated("deprecated in favor of new login flow using com.owncloud.android.presentation.authentication.homecloud.LoginActivity")
class LegacyLoginActivity : AppCompatActivity(), SslUntrustedCertDialog.OnSslUntrustedCertListener, SecurityEnforced {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.root.filterTouchesWhenObscured =
            PreferenceUtils.shouldDisallowTouchesWithOtherVisibleWindows(this@LegacyLoginActivity)
    ...
    private fun getServerInfoIsSuccess(uiResult: UIResult.Success<ServerInfo>) {
        uiResult.data?.run {
            ...
            if (isSecureConnection) {
                ...
                val builder = MaterialAlertDialogBuilder(this@LegacyLoginActivity)
                builder.apply {
