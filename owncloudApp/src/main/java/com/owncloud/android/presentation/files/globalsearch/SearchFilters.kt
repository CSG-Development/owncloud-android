...
enum class TypeFilter(
    ...
    FILE("file", R.string.filter_type_file, R.drawable.ic_file, listOf()),
    FOLDER("folder", R.string.filter_type_folder, R.drawable.ic_folder_outlined, listOf("DIR")),
    DOCUMENT("document", R.string.filter_type_document, R.drawable.ic_document, listOf(
        "application/msword",
        "application/vnd.openxmlformats-officedocument.wordprocessingml",
        "application/vnd.oasis.opendocument.text",
        "text/"
    )),
    SPREADSHEET("spreadsheet", R.string.filter_type_spreadsheet, R.drawable.ic_spreadsheet, listOf(
        "application/vnd.ms-excel",
        "application/vnd.openxmlformats-officedocument.spreadsheetml",
        "application/vnd.oasis.opendocument.spreadsheet"
    )),
    PRESENTATION("presentation", R.string.filter_type_presentation, R.drawable.ic_presentation, listOf(
        "application/vnd.ms-powerpoint",
        "application/vnd.openxmlformats-officedocument.presentationml",
        "application/vnd.oasis.opendocument.presentation"
    )),
    PDF("pdf", R.string.filter_type_pdf, R.drawable.ic_pdf, listOf("application/pdf")),
    IMAGE("image", R.string.filter_type_image, R.drawable.ic_image, listOf("image/")),
    VIDEO("video", R.string.filter_type_video, R.drawable.ic_video, listOf("video/")),
    AUDIO("audio", R.string.filter_type_audio, R.drawable.ic_audio, listOf("audio/")),
    ARCHIVE("archive", R.string.filter_type_archive, R.drawable.ic_archive, listOf(
        "application/zip",
        "application/x-rar",
...
enum class DateFilter(val id: String, val labelResId: Int, val iconResId: Int = R.drawable.ic_calendar) {
    ANY("any", R.string.filter_date_any),
    TODAY("today", R.string.filter_date_today),
    LAST_WEEK("week", R.string.filter_date_week),
    LAST_MONTH("month", R.string.filter_date_month),
    LAST_YEAR("year", R.string.filter_date_year);
...
enum class SizeFilter(val id: String, val labelResId: Int, val iconResId: Int? = null) {
    ANY("any", R.string.filter_size_any, R.drawable.ic_any_size),
    GT_10MB("gt_10mb", R.string.filter_size_gt_10mb),
    LT_10MB("lt_10mb", R.string.filter_size_lt_10mb),
    LT_100MB("lt_100mb", R.string.filter_size_lt_100mb),
    GT_100MB("gt_100mb", R.string.filter_size_gt_100mb),
    LT_500MB("lt_500mb", R.string.filter_size_lt_500mb),
    GT_500MB("gt_500mb", R.string.filter_size_gt_500mb),
    LT_1GB("lt_1gb", R.string.filter_size_lt_1gb),
    GT_1GB("gt_1gb", R.string.filter_size_gt_1gb);
